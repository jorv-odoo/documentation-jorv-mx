...
:ref:`list field <reference/view_architectures/list/field>`.
...
``routing``
    ...
    the user's location is provided). It supports 2 values or can be omitted to disable routing (default: omitted):
